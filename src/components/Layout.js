...
import {
  ...
  Menu,
  X
  // RefreshCw removed - no sync button
} from 'lucide-react';
          ...
          {sidebarOpen && (
            <div className="text-center pt-2">
              <button
                ...
                className="flex items-center justify-center space-x-2 w-full hover:bg-gray-50 dark:hover:bg-gray-700 rounded-lg py-1 transition-colors group"
              >
                <img 
                  src="/icon.jpg" 
                  alt="Developer" 
      ...
      <main className="flex-1 overflow-hidden flex flex-col bg-gray-50 dark:bg-gray-900">
        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              {/* Force Sync Button - DISABLED (Local Database Only) */}
              {/* Cloud sync has been removed - app uses local SQLite database only */}
              ...
              <div className="flex items-center space-x-2 select-none">
                {isOnline ? (
                  <>
                    ...
                    <span className="text-sm text-gray-600 dark:text-gray-400 hidden lg:inline">Online</span>
                  </>
                ) : (
                  <>
